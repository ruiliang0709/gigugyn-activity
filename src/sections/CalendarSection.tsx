...
export default function CalendarSection({
  ...
  onDeletePage, onDeleteAll, onDeleteEvent, onUpdateEvent, onUpdateLinks, onUpdateAIResult, onClearAIResult, hasChanges
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FFFFFF' }}>
      ...
      {selectedEvent && <EventModal event={selectedEvent} onClose={() => setSelectedEvent(null)} onUpdateLinks={onUpdateLinks} onUpdateAIResult={onUpdateAIResult} onClearAIResult={onClearAIResult} onDeleteEvent={onDeleteEvent} onUpdateEvent={onUpdateEvent} />}
